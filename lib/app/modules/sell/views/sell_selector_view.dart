...
class SellSelectorView extends StatelessWidget {
  const SellSelectorView({super.key});
...
class SellSelectorPage extends GetView<SellController> {
  const SellSelectorPage({super.key});
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: 'sell.selector_view.title_part1'.tr),
                    TextSpan(
                      text: 'sell.selector_view.title_part2'.tr,
...
class _TokenCard extends GetView<SellController> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              t.asset_info?.name ?? 'sell.selector_view.unknown_token'.tr,
