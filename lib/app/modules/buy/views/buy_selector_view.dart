...
class BuySelectorView extends StatelessWidget {
  const BuySelectorView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return DynamicAppScaffold(
      ...
      body: BuySelectorPage(),
      bottomNavigationBar: DynamicBottomNavigation(
        currentTab: BottomNavTab.buy,
      ),
    );
  }
}

class BuySelectorPage extends GetView<BuyController> {
  const BuySelectorPage({super.key});
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: 'buy.selector_view.title_part1'.tr),
                    TextSpan(
                      text: 'buy.selector_view.title_part2'.tr,
...
class _TokenCard extends GetView<BuyController> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              t.asset_info?.name ?? 'buy.selector_view.unknown_token'.tr,
