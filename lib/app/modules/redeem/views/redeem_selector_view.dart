...
class RedeemSelectorView extends StatelessWidget {
  const RedeemSelectorView({super.key});
...
class RedeemSelectorPage extends GetView<RedeemController> {
  const RedeemSelectorPage({super.key});
            ...
            children: [
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: 'redeem.selector_view.title_part1'.tr),
                    TextSpan(
                      text: 'redeem.selector_view.title_part2'.tr,
...
class _TokenCard extends GetView<RedeemController> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              t.asset_info?.name ?? 'redeem.selector_view.unknown_token'.tr,
